...
class Room2PageWithDb extends StatefulWidget {
  final ImageProvider? _imageWidget;
  final List<Picture>? _pictures;
  Room2PageWithDb(this._imageWidget, this._pictures);
  @override
  State<StatefulWidget> createState() => _RoomPageState();
}

class _RoomPageState extends State<Room2PageWithDb> {
